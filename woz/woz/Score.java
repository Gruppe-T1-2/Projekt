public class Score {
    ...
    public static void CalculateScore() {
        ...
        String[] Keyset = Game.shoppingList.ItemsMissing.keySet().toArray(new String[4]);
        for (int i = 0; i < Keyset.length; i++) {
            score += 10*Game.shoppingList.ItemsMissing.get(Keyset[i]);
            shoppingScore += 10*Game.shoppingList.ItemsMissing.get(Keyset[i]);
        }
        if (score > scoreGoal) {
            ...
            System.out.println();
            System.out.println("Tak for at spille! Skriv afslut for at lukke spillet.");
        } else if (score > (scoreGoal - intervals*4)) {
